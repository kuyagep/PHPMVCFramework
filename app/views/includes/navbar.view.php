    ...
    <div class="container">
        ...
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div class="d-flex align-items-center flex-equal">
                ...
                <!--begin::Logo image-->
                <a href="<?= ROOT?>">
                        <h1 class="text-white logo-default "><?= APP_NAME?></h1>
                        <h1 class="text-primary logo-sticky"><?= APP_NAME?></h1>
<!--                    <img alt="Logo" src="--><?//= ROOT?><!--/assets/media/logos/logo-landing.svg" class="logo-default h-25px h-lg-30px" />-->
<!--                    <img alt="Logo" src="--><?//= ROOT?><!--/assets/media/logos/logo-landing-dark.svg" class="logo-sticky h-20px h-lg-25px" />-->
                </a>
                <!--end::Logo image-->
            </div>
            <!--end::Logo-->
            ...
            <div class="d-lg-block" id="kt_header_nav_wrapper">
                <div class="d-lg-block p-5 p-lg-0" data-kt-drawer="true" data-kt-drawer-name="landing-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="200px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_landing_menu_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav_wrapper'}">
                    ...
                    <div class="menu menu-column flex-nowrap menu-rounded menu-lg-row menu-title-gray-500 menu-state-title-primary nav nav-flush fs-5 fw-bold" id="kt_landing_menu">
                        ...
                        <div class="menu-item">
                            <!--begin::Menu link-->
                            <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="admin" data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">My Dashboard</a>
                            <!--end::Menu link-->
                        </div>
                        <!--end::Menu item-->
                        <?php endif;?>
            ...
            <!--end::Menu wrapper-->
<!--            <div class="flex-equal text-end text-white">Hi, --><?//= Auth::getFirstname() ?><!--</div>-->
            <?php if(!Auth::logged_in()):?>
                <!--begin::Toolbar-->
                <div class="flex-equal text-end ms-1">
                    <a href="<?=ROOT?>/signin" class="btn btn-success">Sign In</a>
                </div>
                <!--end::Toolbar-->
            <?php else:?>
                <!--begin::Toolbar-->
