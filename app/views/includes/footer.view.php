                ...
                <div class="col-lg-6 ps-lg-16">
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        <div class="d-flex fw-bold flex-column ms-lg-20">
                            ...
                            <!--begin::Link-->
                            <a href="#" class="mb-6">
                                <img src="<?= ROOT?>/assets/media/svg/brand-logos/facebook-4.svg" class="h-20px me-2" alt="" />
                                <span class="text-white opacity-50 text-hover-primary fs-5 mb-6">Facebook</span>
                            </a>
                            <!--end::Link-->
                            <!--begin::Link-->
                            <a href="#" class="mb-6">
                                <img src="<?= ROOT?>/assets/media/svg/brand-logos/github.svg" class="h-20px me-2" alt="" />
                                <span class="text-white opacity-50 text-hover-primary fs-5 mb-6">Github</span>
                            </a>
                            <!--end::Link-->
                            <!--begin::Link-->
                            <a href="#" class="mb-6">
                                <img src="<?= ROOT?>/assets/media/svg/brand-logos/twitter.svg" class="h-20px me-2" alt="" />
                                <span class="text-white opacity-50 text-hover-primary fs-5 mb-6">Twitter</span>
                            </a>
                            <!--end::Link-->
                            <!--begin::Link-->
                            <a href="#" class="mb-6">
                                <img src="<?= ROOT?>/assets/media/svg/brand-logos/dribbble-icon-1.svg" class="h-20px me-2" alt="" />
                                <span class="text-white opacity-50 text-hover-primary fs-5 mb-6">Dribbble</span>
                            </a>
                            <!--end::Link-->
                            <!--begin::Link-->
                            <a href="#" class="mb-6">
                                <img src="<?= ROOT?>/assets/media/svg/brand-logos/instagram-2-1.svg" class="h-20px me-2" alt="" />
            ...
            <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
                ...
                <div class="d-flex align-items-center order-2 order-md-1">
                    ...
                    <a href="../../demo1/dist/landing.html">
                        <img alt="Logo" src="<?= ROOT?>/assets/media/logos/logo-landing.svg" class="h-15px h-md-20px" />
                    </a>
                    <!--end::Logo image-->
                    <!--begin::Logo image-->
...
<script src="<?= ROOT?>/assets/plugins/custom/fslightbox/fslightbox.bundle.js"></script>
<script src="<?= ROOT?>/assets/plugins/custom/typedjs/typedjs.bundle.js"></script>
<!--end::Page Vendors Javascript-->
<!--begin::Page Custom Javascript(used by this page)-->
<script src="<?= ROOT?>/assets/js/custom/landing.js"></script>
<script src="<?= ROOT?>/assets/js/custom/pages/company/pricing.js"></script>
