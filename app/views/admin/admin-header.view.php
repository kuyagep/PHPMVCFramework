...
<head>
    ...
    <link href="<?=ROOT?>/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet"
        type="text/css" />
    <link href="<?=ROOT?>/assets/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true"
                ...
                <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                    <!--begin::Logo-->
                    <a href="<?=ROOT?> ">
                        <img alt="Logo" src="<?=ROOT?>/assets/media/logos/logo-1-dark.svg" class="h-25px logo" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Aside toggler-->
                ...
                <div class="aside-menu flex-column-fluid">
                    ...
                    <div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            <div class="menu-item">
                                <a class="menu-link active" href="<?=ROOT?>/admin/">
                            ...
                            <div class="menu-item">
                                <a class="menu-link active" href="<?=ROOT?>/admin/courses">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <div class="menu-item">
                                <a class="menu-link active" href="<?=ROOT?>/admin/lessons">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        <span class="svg-icon svg-icon-2">
                            ...
                            <div class="menu-item">
                                <a class="menu-link active" href="<?=ROOT?>/admin/history">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    ...
                                    <span class="menu-title">Watch History</span>
                                </a>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link active" href="<?=ROOT?>/admin/sales">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            ...
                            <div class="menu-item">
                                <a class="menu-link active" href="<?=ROOT?>/admin/profile">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                            ...
                            <div class="menu-item">
                                <div class="menu-content pb-2">
                                    <span class="menu-section text-muted text-uppercase fs-8 ls-1">GO TO</span>
                                </div>
                            </div>
                            <div class="menu-item">
                                <a class="menu-link active" href="<?=ROOT?>/home">
                                    <span class="menu-icon">
                                        <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                                        <span class="svg-icon svg-icon-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <div class="aside-footer flex-column-auto pt-5 pb-7 px-5" id="kt_aside_footer">
                    <a href="/mvc/theme/demo1/dist/documentation/getting-started.html" target="_blank"
                ...
                <div id="kt_header" style="" class="header align-items-stretch">
                    ...
                    <div class="container-fluid d-flex align-items-stretch justify-content-between">
                        ...
                        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                            <a href="<?=ROOT?>/admin/" class="d-lg-none">
                                <img alt="Logo" src="<?=ROOT?>/assets/media/logos/logo-2.svg" class="h-30px" />
                            </a>
                        </div>
                        <!--end::Mobile logo-->
                        <!--begin::Wrapper-->
                                ...
                                <div class="header-menu align-items-stretch" data-kt-drawer="true"
                                    ...
                                    <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
                                        ...
                                        <div class="menu-item me-lg-1">
                                            <a class="menu-link active py-3" href="<?=ROOT?>/admin/">
...
-->
                                    ...
                                    <div class="d-flex align-items-center ms-1 ms-lg-3">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px"
                                            ...
                                            <div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10"
                                                style="background-image:url('<?=ROOT?>/assets/media/misc/pattern-1.jpg')">
                                                <!--begin::Title-->
                                    ...
                                    <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                                            ...
                                            <div class="menu-item px-3">
                                                <div class="menu-content d-flex align-items-center px-3">
                                                    ...
                                                    <div class="symbol symbol-50px me-5">
                                                        <img alt="Logo" src="<?=ROOT?>/<?=Auth::getThumbnail()?>" />
                                                    </div>
                                                    <!--end::Avatar-->
                                                    <!--begin::Username-->
                                                    <div class="d-flex flex-column">
                                                        <div class="fw-bolder d-flex align-items-center fs-5">
                                                            <?=ucfirst(Auth::getFirstname()) ." ".ucfirst(Auth::getLastname()) ?>
                                                            <span
                                                                class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2"><?=ucfirst(Auth::getRole())?></span>
                                                        </div>
                                                    ...
                                                    <span class="menu-title position-relative">Language
                                                        <span
                                                            ...
                                                            <img class="w-15px h-15px rounded-1 ms-2"
                                                                src="<?=ROOT?>/assets/media/flags/united-states.svg"
                                                                alt="" /></span></span>
                                                </a>
                                                <!--begin::Menu sub-->
                                                <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="../../demo1/dist/account/settings.html"
                                                            ...
                                                            <span class="symbol symbol-20px me-4">
                                                                <img class="rounded-1"
                                                                    src="<?=ROOT?>/assets/media/flags/spain.svg"
                                                                    alt="" />
                                                            </span>Spanish</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="../../demo1/dist/account/settings.html"
                                                            ...
                                                            <span class="symbol symbol-20px me-4">
                                                                <img class="rounded-1"
                                                                    src="<?=ROOT?>/assets/media/flags/germany.svg"
                                                                    alt="" />
                                                            </span>German</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="../../demo1/dist/account/settings.html"
                                                            ...
                                                            <span class="symbol symbol-20px me-4">
                                                                <img class="rounded-1"
                                                                    src="<?=ROOT?>/assets/media/flags/japan.svg"
                                                                    alt="" />
                                                            </span>Japanese</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="../../demo1/dist/account/settings.html"
                                                            ...
                                                            <span class="symbol symbol-20px me-4">
                                                                <img class="rounded-1"
                                                                    src="<?=ROOT?>/assets/media/flags/france.svg"
                                                                    alt="" />
                                                            </span>French</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                            ...
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-5">
                                                <a href="<?=ROOT?>/logout" class="menu-link px-5">Sign Out</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu separator-->
                                            <div class="separator my-2"></div>
