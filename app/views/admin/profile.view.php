                        ...
                        <div class="col-xl-4">
                            ...
                            <div class="card">
                                <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                    ...
                                    <img src="<?=ROOT?>/<?=esc($row->thumbnail)?>" alt="Profile" class="rounded-circle" style="width: 150px;max-width: 150px;height: 150px;object-fit: cover;">
                                    ...
                                    <div class="tab-content pt-2">
                                        ...
                                        <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-lg-9 col-md-8 text-muted"><?=esc($row->firstname)?> <?=esc($row->lastname)?></div>
                                            </div>
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8 col-lg-9">
                                                        <div class="d-flex ">
                                                            <img class="rounded-2 js-images-preview" src="<?=ROOT?>/<?=esc($row->thumbnail)?>" alt="Profile" style="width: 150px;max-width: 150px;height: 150px;object-fit: cover;">
                                                            <div class="js-filename m-2">Selected File: None</div>
                                                        </div>
                                                        <div class="pt-2">
                                                            <label href="#" class="btn btn-info btn-sm" title="Upload new profile image">
                                                                <i class="bi bi-upload text-white"></i>
                                                                <input onchange="load_image(this.files[0])" type="file" name="thumbnail" style="display: none;">
                                                            </label>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8 col-lg-9">
                                                        <input name="firstname" type="text" class="form-control" id="firstname" value="<?=set_value('firstname', esc($row->firstname))?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8 col-lg-9">
                                                        <input name="lastname" type="text" class="form-control" id="lastname" value="<?=set_value('lastname', esc($row->lastname))?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8 col-lg-9">
                                                        <textarea name="about" class="form-control" id="about" style="height: 100px"><?=set_value('about', esc($row->about))?></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8 col-lg-9">
                                                        <input name="company" type="text" class="form-control" id="company" value="<?=set_value('company', esc($row->company))?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8 col-lg-9">
                                                        <input name="job" type="text" class="form-control" id="job" value="<?=set_value('job', esc($row->job))?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8 col-lg-9">
                                                        <input name="country" type="text" class="form-control" id="country" value="<?=set_value('country', esc($row->country))?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8 col-lg-9">
                                                        <input name="address" type="text" class="form-control" id="address" value="<?=set_value('address', esc($row->address))?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8 col-lg-9">
                                                        <input name="phone" type="text" class="form-control" id="phone" value="<?=set_value('phone', esc($row->phone))?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8 col-lg-9">
                                                        <input name="email" type="email" class="form-control" id="email" value="<?=set_value('email', esc($row->email))?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <a href="<?=ROOT?>/admin/profile"><button type="button" class="btn btn-danger mr-5">Back</button></a>
                                                </div>
