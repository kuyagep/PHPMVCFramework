<?php $this->view('admin/admin-header') ?>
                                            ...
                                            <form id="kt_modal_add_user_form" class="form" action="#">
                                                ...
                                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                                    ...
                                                    <div class="fv-row mb-7">
                                                        ...
                                                        <!--end::Label-->
                                                        <!--begin::Image input-->
                                                        <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url(<?=ROOT?>/assets/media/avatars/blank.png)">
                                                            <!--begin::Preview existing avatar-->
                                                            <div class="image-input-wrapper w-125px h-125px" style="background-image: url(<?=ROOT?>/assets/media/avatars/150-1.jpg);"></div>
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                        <a href="../../demo1/dist/apps/user-management/users/view.html">
                                            <div class="symbol-label">
                                                <img src="<?=ROOT?>/assets/media/avatars/150-26.jpg" alt="Max Smith" class="w-100" />
                                            </div>
                                        </a>
                                    </div>
                                    <!--end::Avatar-->
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                        <a href="../../demo1/dist/apps/user-management/users/view.html">
                                            <div class="symbol-label">
                                                <img src="<?=ROOT?>/assets/media/avatars/150-4.jpg" alt="Sean Bean" class="w-100" />
                                            </div>
                                        </a>
                                    </div>
                                    <!--end::Avatar-->
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                        <a href="../../demo1/dist/apps/user-management/users/view.html">
                                            <div class="symbol-label">
                                                <img src="<?=ROOT?>/assets/media/avatars/150-15.jpg" alt="Brian Cox" class="w-100" />
                                            </div>
                                        </a>
                                    </div>
                                    <!--end::Avatar-->
    ...
    <!--end::Content-->
        ...
        <script src="<?=ROOT?>/assets/plugins/custom/datatables/datatables.bundle.js"></>
