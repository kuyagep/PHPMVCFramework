                    ...
                    <form method="post">
                        <div class="py-5">
                            <div class="rounded border-0 p-10">
                                ...
                                <div class="mb-10">
                                    <select name="category_id" id="exampleFormControlInput1" class="form-select <?=!empty($errors['category_id']) ? 'border-danger':'';?>" aria-label="" >
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="<?=ROOT?>/admin/courses"><button type="button" class="btn btn-primary">Cancel</button></a>
                                </div>
                            </div>
                        </div>
                    </form>
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <button type="button" class="btn btn-primary" >
                                    ...
                                    <!--end::Svg Icon-->New Course</button>
                                </a>
                                <!--end::Add user-->
                            </div>
                            <!--end::Toolbar-->
